...
namespace Ashirvad.Repo.Services.Area.UserRights
{
    public class UserRightsAPI : ModelAccess, IUserRightsAPI
    {
        ...
        //                      Userinfo = new UserEntity()
        //                      {
        //                          UserName = u.User_MASTER.User_name,
        //                          UserID = u.User_id
        //                      },
        ...
        //                || u.User_MASTER.User_name.ToLower().Contains(model.search.value))
        //                select new UserWiseRightsEntity()
        //                {
        //                    Userinfo = new UserEntity()
        //                    {
        ...
        //                        Package = u.PACKAGE_MASTER.package
        //                    },
        //                    UserWiseRightsID = u.Userrights_id,
        //                    Count = count
        //                }).Distinct()
        ...
        //                         Userinfo = new UserEntity()
        //                         {
        //                             UserName = page.User_MASTER.User_name,
        //                             UserID = page.User_id,
        //                         },
        //                         Packageinfo = new PackageEntity()
        //                         {
        ...
        //                where u.row_sta_cd == 1 && u.role_id == RoleID && PM.row_sta_cd == 1 && page.row_sta_cd == 1
        //                select new UserWiseRightsEntity()
        //                {
        //                    RowStatus = new RowStatusEntity()
        //                    {
